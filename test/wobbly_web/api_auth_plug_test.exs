defmodule WobblyWeb.APIAuthPlugTest do
  use WobblyWeb.ConnCase
  doctest WobblyWeb.APIAuthPlug

  alias WobblyWeb.{APIAuthPlug, Endpoint}
  alias Wobbly.{Repo, Users.User}

  @pow_config [otp_app: :wobbly]
